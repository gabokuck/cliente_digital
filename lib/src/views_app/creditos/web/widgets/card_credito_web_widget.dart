...
class CardCreditoWebWidget extends StatefulWidget {
  ...
  const CardCreditoWebWidget({Key? key,
  ...
  @override
  _CardCreditoWebWidgetState createState() => _CardCreditoWebWidgetState();
}

class _CardCreditoWebWidgetState extends State<CardCreditoWebWidget> {
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Text('Crédito #123456', style: GoogleFonts.montserrat(fontSize: 15),),
                MouseRegion(
